...
- **色分け反応**: 反応ごとに異なる色（へぇ=オレンジ、いいね=青、？？？=赤、ぱちぱち=黄色、www=緑）
...
### v2.1.4（機能拡張とUI改善）
- **wwwリアクション追加**：新しい反応ボタン「www」を緑色で追加
- **回答表示機能**：「x件の回答」ボタンをクリックで回答内容を表示/非表示切り替え
- **リアクション色変更**：いいね=青、？？？=赤、ぱちぱち=黄色、www=緑に変更
- **回答モーダル改善**：モーダルサイズをmax-w-2xlに拡大、入力欄を5行に拡大
- **UI改善**：回答ボタンを緑色に変更して回答件数ボタン（青）と区別
...
- 回答表示機能：expandedReplies Stateで回答展開状態を管理
- モーダルUI改善：max-w-2xlサイズ、スクロール対応、大きな入力欄
